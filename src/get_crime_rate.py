...
def get_crime_rate(crime_info):
    ...
    Because the website does not provide API, the whole scraping process is about 2 hours.
    To reduce the waiting time, scraped data are stored in csv file.
    ...
    try:
        f= open('crime rate.csv','w',encoding='utf-8')
